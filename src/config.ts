...
export default {
  ...
  jobtitle: 'Лидер компетенций разработки',
  ...
  experience: [
    {
      ...
      title: "Лидер компетенций разработки",
      responsibilities: [
        "Организация процесса разработки",
        "Обучение сотрудников, передача компетенций",
      ...
      tags: ["Vuejs","Ruby on Rails","PostgreSQL", "Ant Design", "PrimeVue", "Kubernetes"],
    ...
    },
    {
      ...
      period: "2024",
      сompany: "СЛЁРМ",
      title: "Soft Skills и управление",
      responsibilities: [
        "Саморазвитие",
        "Самолидерство",
        "Коммуникация",
      ...
      tags: ["Саморазвитие","Самолидерство","Дорофеев","Soft Skills"],
      links: [{to: 'https://slurm.io/soft-skills-for-leads#program', text: 'Описание интенсива'}]
    },
    {
      type: "job",
      period: "2024 - 2025",
